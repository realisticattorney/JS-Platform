...
export default class TitleScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.scoreButton = new Button(this, config.width / 2, config.height / 2 + 100, 'blueButton1', 'blueButton2', 'Score', 'Score');

    this.intructionsButton = new Button(this, config.width / 2, config.height / 2 + 200, 'blueButton1', 'blueButton2', 'Instr.', 'Instructions');
